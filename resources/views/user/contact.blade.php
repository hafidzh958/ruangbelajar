...
@php
$waNumber   = $settings['contact_whatsapp'] ?? $settings['contact_cta_whatsapp_number'] ?? '6283157112597';
$waClean    = preg_replace('/\D/', '', $waNumber);
$jamOps     = $settings['contact_jam_operasional'] ?? 'Senin–Sabtu, 08:00–18:00 WIB';
$alamat     = $settings['contact_alamat'] ?? $settings['contact_location_address'] ?? 'Tajur, Bogor Selatan, Kota Bogor, Jawa Barat';
$email      = $settings['contact_email'] ?? $settings['contact_location_email'] ?? 'halo@ruangbelajar.com';
$mapsEmbed  = $settings['contact_maps_embed_url'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15852.793739791404!2d106.81533031024503!3d-6.62228551469502!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5e7b7fcc903%3A0xc3972236a2818619!2sTajur%2C%20Kec.%20Bogor%20Sel.%2C%20Kota%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1710000000000!5m2!1sid!2sid';
@endphp
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
        ...
        <div data-aos="fade-right">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <p class="text-blue-300 font-bold text-xs uppercase tracking-widest italic opacity-80">Admin Standby 24/7</p>
                        </div>
                    </div>
            ...
            <div class="mt-16 p-12 bg-blue-50 border border-blue-100 rounded-[4rem] flex flex-col md:flex-row items-center gap-10">
                ...
                <div>
                    <h4 class="text-2xl font-black italic uppercase tracking-tighter text-brand-dark">Jam Operasional</h4>
                    <p class="text-slate-500 font-bold italic mt-2">{{ $jamOps }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-12">
                <div class="flex gap-10 items-start">
                    ...
                    <div>
                        ...
                        <p class="text-xl text-slate-500 font-medium leading-relaxed italic opacity-80">{{ $alamat }}</p>
                    </div>
                </div>
                @if($email)
                <div class="flex gap-10 items-start">
                    ...
                    <div>
                        ...
                        <p class="text-xl text-slate-500 font-medium leading-relaxed italic opacity-80">{{ $email }}</p>
                    </div>
                </div>
                @endif
